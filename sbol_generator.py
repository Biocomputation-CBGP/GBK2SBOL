...
class SBOLGenerator:
    ...
    def _generic_generation(self,uri,type):
        ...
        triples.append((uri,URIRef("http://wiki.synbiohub.org/wiki/Terms/synbiohub#ownedBy"),URIRef("http://sevahub.es/user/sevahub")))
        return triples
    ...
    def component_definition(self,uri,type,role=None,components=[],sas=[],properties={}):
        ...
        if DCTERMS.description in properties:
            properties[URIRef("http://wiki.synbiohub.org/wiki/Terms/synbiohub#mutableDescription")] = properties[DCTERMS.description]
        properties[DCTERMS.description] = Literal(_get_name(uri))
        properties[URIRef("http://wiki.synbiohub.org/wiki/Terms/synbiohub#topLevel")] = uri

        for k,v in properties.items():
            triples.append((uri,k,v))
        return triples

    def component(self,uri,definition,parent):
        ...
        triples.append((uri,URIRef("http://sbols.org/v2#roleIntegration"),URIRef("http://sbols.org/v2#mergeRoles")))
        return triples
    ...
    def sequence_annotation(self,uri,start,end,strand,parent,component=None):
